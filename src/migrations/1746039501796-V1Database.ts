...
export class V1Database1746039501796 implements MigrationInterface {
    name = 'V1Database1746039501796'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Experience" ("experienceId" SERIAL NOT NULL, "name" character varying(50), "description" character varying(150), "amountPerson" integer NOT NULL, "amount" integer NOT NULL, "priceSale" numeric(10,2) NOT NULL, "checkInDate" date, "checkOutDate" date, "reservationDate" date, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "availableTypeId" integer, "taxeTypeId" integer, "categoryTypeId" integer, CONSTRAINT "PK_25512aa2f769e858fb8f000c895" PRIMARY KEY ("experienceId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Experience" ADD CONSTRAINT "FK_9eef7ee011780c6cd6a797282ee" FOREIGN KEY ("availableTypeId") REFERENCES "AdditionalType"("additionalTypeId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
