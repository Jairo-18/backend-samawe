...
export class AddedEndStartDateInInvoiceDetaill1749069407765 implements MigrationInterface {
    name = 'AddedEndStartDateInInvoiceDetaill1749069407765'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "InvoiceDetaill" ("invoiceDetailId" SERIAL NOT NULL, "amount" numeric(10,2) NOT NULL, "priceWithoutTax" numeric(10,2) NOT NULL, "priceWithTax" numeric(10,2) NOT NULL, "subtotal" numeric(10,2) NOT NULL, "startDate" date, "endDate" date, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "invoiceId" integer, "productId" integer, "accommodationId" integer, "excursionId" integer, "taxeTypeId" integer, CONSTRAINT "PK_67423012bd6d16b68c2735eb4b5" PRIMARY KEY ("invoiceDetailId"))`);
