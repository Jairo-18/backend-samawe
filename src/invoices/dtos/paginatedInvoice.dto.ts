...
import { PAGINATED_INVOICE_EXAMPLE } from '../constants/exampleInvoices.conts';
...
export class PaginatedInvoiceResponseDto extends ResponsePaginationDto<GetInvoiceWithDetailsDto> {
  @ApiProperty({
    ...
    isArray: true,
    example: PAGINATED_INVOICE_EXAMPLE.data,
  })
  data: GetInvoiceWithDetailsDto[];

  constructor(data: GetInvoiceWithDetailsDto[], pagination: PageMetaDto) {
