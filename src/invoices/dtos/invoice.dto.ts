...
export class CreateInvoiceDetailDto {
  @ApiPropertyOptional({
    description: 'ID del producto asociado al detalle de la factura',
    example: 10,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'ID del hospedaje asociado al detalle de la factura',
    example: 5,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'ID de la excursión asociada al detalle de la factura',
    example: 8,
  })
  @IsOptional()
  @IsNumber()
